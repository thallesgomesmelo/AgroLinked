        ...
        <div className="container">
          <div className="story-content">
            <div className="story-text">
              ...
              <p>
                A AgroLinked nasceu em 2018 da visão de um grupo de engenheiros
                agrônomos e especialistas em tecnologia que acreditavam no
                potencial da transformação digital para o agronegócio
                brasileiro.
              </p>
              <p>
                Começamos desenvolvendo soluções simples para monitoramento de
                lavouras e, ao longo dos anos, expandimos nossa plataforma para
                uma solução completa que integra IoT, inteligência artificial e
                análise de dados para otimizar todos os aspectos da produção
                agrícola.
              </p>
              <p>
                Hoje, a AgroLinked é reconhecida como uma das principais
                empresas de tecnologia para o agronegócio, com presença em todo
                o Brasil e expansão para outros países da América Latina.
              </p>
            </div>
            <div className="story-image">
              <img src="/img/Placa.png" alt="História da AgroLinked" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mission-vision">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Conheça os princípios que norteiam nosso trabalho e nossa visão
          ...
          <div className="mvv-grid">
            <div className="mvv-card">
              <h3>Missão</h3>
              <p>
                Transformar o agronegócio através da tecnologia, promovendo
                práticas mais eficientes, sustentáveis e lucrativas para
            ...
            <div className="mvv-card">
              <h3>Visão</h3>
              <p>
                Ser a principal plataforma tecnológica para o agronegócio
                global, impulsionando a transformação digital do setor e
                contribuindo para a segurança alimentar mundial.
              </p>
            </div>
      ...
      <section className="key-numbers">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Conheça o impacto da nossa tecnologia no agronegócio brasileiro e
              mundial.
            </p>
          </div>
      ...
      <section className="team">
        <div className="container">
          <div className="section-header">
            <h2>Nossa Equipe</h2>
            <p>
              Conheça os profissionais apaixonados por tecnologia e agronegócio
              que fazem a AgroLinked acontecer.
            </p>
          </div>
          ...
          <div className="team-grid">
            ...
            <div className="team-member">
              <div className="member-photo">
                <img src="/img/Ana Costa.jpg" alt="Head of Research" />
              </div>
              <h3>Ana Costa</h3>
      ...
      <section className="partners">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Trabalhamos com as principais instituições e empresas do setor
