        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              <h1>
                Transformando o <span>Agronegócio</span> com Tecnologia
              </h1>
              <p>
                Soluções tecnológicas inovadoras para aumentar a produtividade e
            ...
            <div className="hero-image">
              <img src="/img/logo.jpg" alt="Tecnologia no Agronegócio" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="features">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Nossa plataforma oferece soluções completas para modernizar e
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Soluções que promovem práticas agrícolas sustentáveis e reduzem
                o impacto ambiental.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Insights baseados em dados para tomada de decisões mais
            ...
            <div className="feature-card">
              ...
              <p>
                Acompanhe sua produção em tempo real de qualquer lugar, com
            ...
            <div className="feature-card">
              ...
              <p>
                Automatize processos e aumente a eficiência operacional com
            ...
            <div className="feature-card">
              ...
              <p>
                Proteção avançada para seus dados e informações sensíveis com
            ...
            <div className="feature-card">
              ...
              <p>
                Integração perfeita com seus sistemas existentes e outras
